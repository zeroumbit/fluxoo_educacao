...
import { FileUser,Package,Search,Wallet } from 'lucide-react'
...
// Pages - Admin (Escola)
const DashboardPage = lazy(() => import('@/modules/alunos/pages/DashboardPage'))
const ProfessorDashboardPage = lazy(() => import('@/modules/professor/pages/ProfessorDashboardPage'))
const AlunosListPage = lazy(() => import('@/modules/alunos/pages/AlunosListPage'))
...
const PlanoAulaPage = lazy(() => import('@/modules/academico/pages/PlanoAulaPage'))
const AtividadesPage = lazy(() => import('@/modules/academico/pages/AtividadesPage'))
const NotasPage = lazy(() => import('@/modules/academico/pages/NotasPage'))
const TransferenciasPage = lazy(() => import('@/modules/academico/pages/TransferenciasPage'))
const DisciplinasPage = lazy(() => import('@/modules/academico/pages/DisciplinasPage'))
