      ...
      <div className="p-4 space-y-6">
        <div className="flex gap-3 overflow-x-auto pb-1 scrollbar-hide -mx-4 px-4">
          ...
          <div className={cn(
            ...
            <span className="text-sm font-black">{chamadasPendentes} Pendencias</span>
          </div>
          <div className="flex items-center gap-2 bg-white border border-zinc-200 px-5 py-3 rounded-[24px] text-zinc-600 shrink-0">
            ...
            <span className="text-sm font-black">Proxima: {proximaAula?.hora_inicio?.substring(0, 5) || '--:--'}</span>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <input
            type="text"
            placeholder="Filtrar por turma ou materia..."
            value={busca}
                ...
                <motion.div
                  ...
                  onClick={() => {
                    if (!aula.chamada_realizada) {
                      navigate(`/professores/frequencia?turma=${aula.turma_id}&data=${aula.data_aula}`)
                    } else if (!aula.conteudo_registrado) {
                      navigate('/professores/planos-aula')
                    } else {
                      navigate(`/professores/turmas/${aula.turma_id}`)
                    }
                  }}
                >
                    ...
                    <CardContent className="p-0">
                      <div className="flex items-stretch min-h-[120px]">
                        <div className="w-20 bg-zinc-50 flex flex-col items-center justify-center border-r border-zinc-100/50 gap-1">
                          <span className="text-xs font-black text-zinc-400 uppercase tracking-tighter">Inicio</span>
                          ...
                          <div className="flex justify-between items-start gap-2">
                            <div className="min-w-0">
                              ...
                              <div className="flex items-center gap-1.5 mt-0.5 opacity-60">
                                ...
                                <span className="text-[11px] font-bold uppercase tracking-wider">{aula.sala || 'Sala nao inf.'}</span>
                              </div>
                            </div>
                            ...
                            <div className="flex gap-2">
                              ...
                              {aula.conteudo_registrado && (
                                <div className="flex items-center gap-1 bg-indigo-50 text-indigo-700 px-2 py-1 rounded-lg ring-1 ring-indigo-100">
                                  <Check className="w-3 h-3" />
                                  <span className="text-[9px] font-black uppercase tracking-wider">Conteudo</span>
                                </div>
                              )}
                            </div>
